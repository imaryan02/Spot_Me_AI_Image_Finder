    ...
    <div className="flex flex-col h-full animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-6 bg-card border-b border-gray-800 sticky top-0 z-30">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={handleShare}
            disabled={selectedIds.size === 0 && !navigator.canShare}
            className="px-4 py-2 border border-gray-600 hover:bg-gray-700 text-white rounded-lg font-medium text-sm transition-colors flex items-center gap-2"
          >
